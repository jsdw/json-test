...
var _jsdw$json_test$JsonTest$onChange = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'change',
		A2(
...
var _jsdw$json_test$JsonTest$row = F3(
	function (name, id, input) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('row-name')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('row-input')
						]),
					_elm_lang$core$Native_List.fromArray(
						[input]))
				]));
	});
var _jsdw$json_test$JsonTest$viewResponse = function (res) {
	var viewBody = function (val) {
		var _p0 = val;
		if (_p0.ctor === 'Text') {
			return _elm_lang$html$Html$text(_p0._0);
		} else {
			return _elm_lang$html$Html$text('Cannot view body: not a string');
		}
	};
	var viewHeader = function (_p1) {
		var _p2 = _p1;
		return A3(
			_jsdw$json_test$JsonTest$row,
			_p2._0,
			'',
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(details.status),
							A2(_elm_lang$core$Basics_ops['++'], ': ', details.statusText)))),
					A3(
					_jsdw$json_test$JsonTest$row,
					'Headers',
					'',
					A2(
						...
						A2(
							_elm_lang$core$List$map,
							viewHeader,
							_elm_lang$core$Dict$toList(details.headers)))),
					A3(
					_jsdw$json_test$JsonTest$row,
					'Body',
					'',
					viewBody(details.value))
				]));
	};
	var responseError = _elm_lang$html$Html$text('There was a low level error processing your request.');
	var noResponse = _elm_lang$html$Html$text('No request made');
	var _p3 = res;
	if (_p3.ctor === 'Nothing') {
		return noResponse;
	} else {
		var _p4 = _p3._0;
		if (_p4.ctor === 'Ok') {
			return response(_p4._0);
		} else {
			if (_p4._0.ctor === 'RawTimeout') {
				return _elm_lang$html$Html$text('There was a network timeout.');
			} else {
				return _elm_lang$html$Html$text('There was a network error of some sort (bad URL?)');
			}
		}
	}
};
var _jsdw$json_test$JsonTest$isJust = function (m) {
	var _p5 = m;
	if (_p5.ctor === 'Nothing') {
		return false;
	} else {
...
var _jsdw$json_test$JsonTest$Model = F5(
	function (a, b, c, d, e) {
		return {path: a, req: b, verb: c, res: d, loading: e};
	});
var _jsdw$json_test$JsonTest$init = {
	ctor: '_Tuple2',
	_0: A5(_jsdw$json_test$JsonTest$Model, '', '', 'GET', _elm_lang$core$Maybe$Nothing, false),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _jsdw$json_test$JsonTest$Submit = {ctor: 'Submit'};
var _jsdw$json_test$JsonTest$ResError = function (a) {
	return {ctor: 'ResError', _0: a};
};
var _jsdw$json_test$JsonTest$ResSuccess = function (a) {
	return {ctor: 'ResSuccess', _0: a};
};
var _jsdw$json_test$JsonTest$makeRequestGiven = function (model) {
	...
	var request = {
		...
		headers: headers,
		url: model.path,
		body: _evancz$elm_http$Http$string(model.req)
	};
	return A3(
		_elm_lang$core$Task$perform,
		_jsdw$json_test$JsonTest$ResError,
		_jsdw$json_test$JsonTest$ResSuccess,
		A2(_evancz$elm_http$Http$send, _evancz$elm_http$Http$defaultSettings, request));
};
var _jsdw$json_test$JsonTest$update = F2(
	function (action, model) {
		var noFx = function (m) {
			return {ctor: '_Tuple2', _0: m, _1: _elm_lang$core$Platform_Cmd$none};
		};
		var _p6 = A2(_elm_lang$core$Debug$log, 'change', action);
		switch (_p6.ctor) {
			case 'Path':
				return noFx(
					_elm_lang$core$Native_Utils.update(
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{loading: true, res: _elm_lang$core$Maybe$Nothing}),
					_1: _jsdw$json_test$JsonTest$makeRequestGiven(model)
				};
		}
	});
var _jsdw$json_test$JsonTest$ReqBody = function (a) {
	return {ctor: 'ReqBody', _0: a};
};
var _jsdw$json_test$JsonTest$ReqVerb = function (a) {
	return {ctor: 'ReqVerb', _0: a};
};
var _jsdw$json_test$JsonTest$Path = function (a) {
	return {ctor: 'Path', _0: a};
};
var _jsdw$json_test$JsonTest$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('JSON Tester')
					])),
				A2(
				_elm_lang$html$Html$table,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$id('input-path'),
									_elm_lang$html$Html_Events$onInput(_jsdw$json_test$JsonTest$Path),
									_elm_lang$html$Html_Attributes$value(model.path)
								]),
							_elm_lang$core$Native_List.fromArray(
								[]))),
						A3(
						...
						A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$id('input-method'),
									_jsdw$json_test$JsonTest$onChange(_jsdw$json_test$JsonTest$ReqVerb)
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$core$Native_Utils.eq(model.verb, 'GET')),
											_elm_lang$html$Html_Attributes$value('GET')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('GET')
										])),
									A2(
									_elm_lang$html$Html$option,
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$selected(
											_elm_lang$core$Native_Utils.eq(model.verb, 'POST')),
											_elm_lang$html$Html_Attributes$value('POST')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
						...
						A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Events$onInput(_jsdw$json_test$JsonTest$ReqBody),
									_elm_lang$html$Html_Attributes$value(model.req)
								]),
							_elm_lang$core$Native_List.fromArray(
								[]))),
						A2(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Events$onClick(_jsdw$json_test$JsonTest$Submit)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Fetching Response...')
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Basics$not(
									_jsdw$json_test$JsonTest$isJust(model.res)))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_jsdw$json_test$JsonTest$viewResponse(model.res)
							]))
					]))
			]));
};

var _jsdw$json_test$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _jsdw$json_test$JsonTest$init,
			update: _jsdw$json_test$JsonTest$update,
			view: _jsdw$json_test$JsonTest$view,
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _jsdw$json_test$Main$main === 'undefined' ? null : _jsdw$json_test$Main$main);
